...
LOG=r'mnist_convnet_model'
tf.logging.set_verbosity(tf.logging.INFO)

############################################ MNIST DATASET #############################################

DATA_TRAIN_SIZE=20000 #Total data:55000
DATA_EVAL_SIZE=4000   #Total data:10000
...
def main(unused_argv):
    ...
    # Criação do modelo
    model = learn.Estimator(model_fn=config_model, model_dir=LOG)
